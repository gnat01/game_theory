...
def simulate_population(
    ...
    return v_a0, v_b0, snap_v_a, snap_v_b, v_a, v_b
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--plot-out", type=str, required=True, help="Output PNG path for the 2x2 plot.")
...
def main() -> int:
    ...
    v_a0_plot, v_b0_plot, snap_v_a, snap_v_b, v_a_final, v_b_final = simulate_population(
        v_a0=v_a0,
        v_b0=v_b0,
        delta_a=delta_a,
        delta_b=delta_b,
